...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Test PT. SEI</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item">
						<a href="<?= base_url('proyek') ?>" class="nav-link <?php if($this->uri->segment(1) == 'proyek') echo 'active' ?>">
					...
					<li class="nav-item">
						<a href="<?= base_url('lokasi') ?>" class="nav-link <?php if($this->uri->segment(1) == 'lokasi') echo 'active' ?>">
